...
public class ReceiverSnmpPrevail extends WosBaseSnmp {
	...
	public ReceiverSnmpPrevail(String phsicIndex) {
		...
		// major
		int vIns = 0;
		nojuParmsTableRow row1 = pmls.tab1.get("fnRFChannelNum");
		...
		row1 = pmls.tab1.get("fnOpticalReceiverPower");
