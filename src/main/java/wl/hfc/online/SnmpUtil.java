...
//								+ "XXXXX Bu Tong-- Bu Bu Bu Bu  Tong----------------------------");
	...
	public int gethfcNextPDU(String host, String port, OID oid,String community)
			throws IOException {
			int result = -1;
			try {
	...
	public PDU gethfcINT32noju(String host, String port,String community,PDU outpdu)
		throws IOException {
		...
		try {
			...
			ResponseEvent responseEvent = snmp.send(outpdu, target); //
