...
public class nojuTrapLogTableRow implements Serializable {
	...
	public nojuTrapLogTableRow(int level, TrapLogTypes type, String addr, String neName, String content,
			java.util.Date time, String tMent, String isTreatMent, String paramName, String pValue) {
		TrapLogID = 0;
		this.level = level;
		TrapLogType = type;
		TrapDevAddress = addr;
