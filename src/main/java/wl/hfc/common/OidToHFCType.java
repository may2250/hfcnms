...
public class OidToHFCType
{
    ...
    //，如lid == ".1.3.6.1.4.1.17409.1.11"是标准的EDFA设备，直接被识别为prevail的EDFA，调用第三方厂家的识别逻辑后，会将识别结果更改覆盖；
   // public static EnumLogoVersion logoVersion = EnumLogoVersion.prevail;
    ...
    public static HFCTypes GetHFCTypeByOid(String system0id, String commonDeviceOid, String stringMD, String stringID)
    {
        ...
        {
            if (stringID.equalsIgnoreCase( "ScanID                         " )|| stringID.equalsIgnoreCase( "WL00OR220000"))
            {
                if (stringMD.equalsIgnoreCase( "WR8602JL" )|| stringMD.equalsIgnoreCase( "WR8604JL" )|| stringMD.equalsIgnoreCase( "WR8602RJ" )|| stringMD.equalsIgnoreCase( "WR8602RJL" )||
                 stringMD.equalsIgnoreCase( "WR8604RJL" )|| stringMD.equalsIgnoreCase( "WR8604DJ" )|| stringMD.equalsIgnoreCase( "WR8602JL-CM" )|| stringMD.equalsIgnoreCase( "WR8600"
                   )|| stringMD.equalsIgnoreCase( "WR1004DJ" )|| stringMD.equalsIgnoreCase( "WR1002RJ" )|| stringMD.equalsIgnoreCase( "SCN-1000-2" )|| stringMD.equalsIgnoreCase( "SCN-870-2" )|| stringMD.equalsIgnoreCase( "WR8602ML" )|| stringMD.equalsIgnoreCase( "WR8602JLE"
              )|| stringMD.equalsIgnoreCase( "WR8602ME" )|| stringMD.equalsIgnoreCase( "FMAU1121" )|| stringMD.equalsIgnoreCase( "WR8602MF-B" )|| stringMD.equalsIgnoreCase( "WR8602M-B" )|| stringMD.equalsIgnoreCase( "WR8604DJ-1G" )|| stringMD.equalsIgnoreCase( "OPS2600"
                ...
                else if (stringMD.equalsIgnoreCase( "WR8604HA" )|| stringMD.equalsIgnoreCase( "WR8604G-S" )|| stringMD.equalsIgnoreCase( "WR8602G-S" )|| stringMD.equalsIgnoreCase( "WR8604HC" )|| stringID.equalsIgnoreCase( "HC-860"))
                    return HFCTypes.HfcPR0WorkStation;
                else if (stringMD.equalsIgnoreCase( "WR8604HJ" )|| stringMD.equalsIgnoreCase( "SCN-1000-4" )|| stringMD.equalsIgnoreCase( "SCN-870-4" )|| stringMD.equalsIgnoreCase( "WR8604HJ-1G"
                )|| stringMD.equalsIgnoreCase( "OPS2500" )|| stringMD.equalsIgnoreCase( "WR8604HJ-1G-2P" )|| stringMD.equalsIgnoreCase( "OPS2500-D2R" )|| stringMD.equalsIgnoreCase( "WR8604"))
                    return HFCTypes.HfcWorkStationWR8604HJ;
                else
                    return HFCTypes.HfcMinWorkstation;
            }

            else if (stringID.equalsIgnoreCase( "JLE-86-2" )|| stringID.equalsIgnoreCase( "CEAM-1G-2" )|| stringID.equalsIgnoreCase( "JL-86-2" )|| stringID.equalsIgnoreCase( "DJ-1G-4" )|| stringID.equalsIgnoreCase( "DJ-1G-4-R"
                )|| stringID.equalsIgnoreCase( "DJ-86-4" )|| stringID.equalsIgnoreCase( "JL-86-4" )|| stringID.equalsIgnoreCase( "RJL-86-4" )|| stringID.equalsIgnoreCase( "RJL-86-2" )|| stringID.equalsIgnoreCase( "RJ-86-2"
                )|| stringID.equalsIgnoreCase( "RJ-1G-2" )|| stringID.equalsIgnoreCase( "J-1G-2S" )|| stringID.equalsIgnoreCase( "ML-86-2" )|| stringID.equalsIgnoreCase( "JE-1G-2" )|| stringID.equalsIgnoreCase( "JLE-1G-2"
               )|| stringID.equalsIgnoreCase( "DM-86-2" )|| stringID.equalsIgnoreCase( "ME-86-2" )|| stringID.equalsIgnoreCase( "JL-CM-2" )|| stringID.equalsIgnoreCase( "J-1G-2" )|| stringID.equalsIgnoreCase( "JL-1G-2S" )|| stringID.equalsIgnoreCase( "JL-1G-2"
               )|| stringID.equalsIgnoreCase( "JL-1G-4" )|| stringID.equalsIgnoreCase( "J-B-1G-2" )|| stringID.equalsIgnoreCase( "M-B-86-2" )|| stringID.equalsIgnoreCase( "CEAM-1G-2" )|| stringID.equalsIgnoreCase( "RJ-1G-2-II" )|| stringID.equalsIgnoreCase( "RJ-1G-2-III" )|| stringID.equalsIgnoreCase( "ID-FMAU" )|| stringID.equalsIgnoreCase( "ID-FMAU-2"))
                return HFCTypes.HfcMinWorkstation;
            else if (stringID.equalsIgnoreCase( "JDS-86-2"))
                return HFCTypes.HfcReceJDS;
            else if (stringID.equalsIgnoreCase( "HJ-1G" )|| stringID.equalsIgnoreCase( "HJ-860"))
                return HFCTypes.HfcWorkStationWR8604HJ;
            else if (stringID.equalsIgnoreCase( "JS-1G-2" )|| stringID.equalsIgnoreCase( "JS-1G-2S" )|| stringID.equalsIgnoreCase( "JSE-1G-2" )|| stringID.equalsIgnoreCase( "JDS-1G-2-II"))
    ...
    public static HFCTypes getType(Vector<VariableBinding> recVBs)
    {
        ...
        else if (recVBs.size() == 3)
        {
          ...
          /*      else if (oid2222.c("5000"))
                {
                    devtype = HFCTypes.wos5000;
                }*/
                else
                {
            ...
            {
     /*           if (CommonHardCoding.logoVersion == EnumLogoVersion.ascent)
                {
                    devtype = HFCTypes.wos4000;
                }
*/
